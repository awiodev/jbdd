...
public abstract class JBddBaseExtension<TRun extends JBddBaseRun<?>> implements BeforeEachCallback,
    AfterEachCallback, BeforeAllCallback, AfterAllCallback, ParameterResolver {

    @FunctionalInterface
    public interface JBddSetup<TRun extends JBddBaseRun<?>> {
        TRun perform();
    }

    @FunctionalInterface
    public interface JBddTearDown<TRun extends JBddBaseRun<?>> {
    ...
    public boolean supportsParameter(ParameterContext parameterContext,
        ...
        return JBddBaseRun.class.isAssignableFrom(parameterContext.getParameter().getType());
    }
